...
def get_enrichment_from_llm(lat: float, lon: float, name: str) -> Dict[str, str]:
    """
    Pillar 2 & 3: Resolves Planning Area and adds Cultural/Historical Context.
    """
    ...
    try:
        ...
        return {"planning_area": "Singapore", "cultural_insight": "A notable establishment in the heart of the city."}
